...
//    Verify if doesn't already exist a rental to the vehicle with some date between checkin and checkout that was chosen
    private boolean checkRentals(Vehicle vehicle, Instant checkin, Instant checkout){
