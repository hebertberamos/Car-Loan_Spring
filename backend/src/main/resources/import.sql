...
INSERT INTO tb_vehicle (img, name, brand, plate, manufacture_Year, status, description, price_Per_Hour, price_Per_Day, available, rating) VALUES ('https://www.honda.com.br/motos/sites/hda/files/2023-08/moto-honda-cg-160-titan-azul-perolizado_3.webp', 'Honda CG 160', 'Honda', 'A1A11', 2022, 1, 'Descubra o futuro da AMG Driving Performance. E temos excelentes novidades, porque criamos um veículo totalmente elétrico que também é um autêntico AMG. Como sempre, praticidade no dia a dia e fascinação estão incluídas. Venha para a linha de largada.', 50.0, 150.0, true, 3.4);
