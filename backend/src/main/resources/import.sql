...
INSERT INTO tb_vehicle (name, brand, plate, manufacture_Year, status, description, price_Per_Hour, price_Per_Day, available, rating) VALUES ('Fiat Mobi Like 1.0', 'Fiat', 'B1BBB11', 2021, 1, 'Descubra o futuro da AMG Driving Performance. E temos excelentes novidades, porque criamos um veículo totalmente elétrico que também é um autêntico AMG.', 80.0, 200.0, true, 4.5);
INSERT INTO tb_car (id, number_Of_Doors, Trunk_Space, has_Step) VALUES (2, 4, 1.2, true);

INSERT INTO tb_vehicle (name, brand, plate, manufacture_Year, status, description, price_Per_Hour, price_Per_Day, available, rating) VALUES ('Mercedes-Benz W113', 'Mercedes', 'C1CCC11', 1969, 2, 'Descubra o futuro da AMG Driving Performance. E temos excelentes novidades, porque criamos um veículo totalmente elétrico que também é um autêntico AMG. Como sempre, praticidade no dia a dia e fascinação estão incluídas. Venha para a linha de largada.', 350.0, 1500.0, true, 5.0);
INSERT INTO tb_car (id, number_Of_Doors, Trunk_Space, has_Step) VALUES (3, 2, 2.3, false);

-- Vehicle / motorcycle
INSERT INTO tb_vehicle (name, brand, plate, manufacture_Year, status, description, price_Per_Hour, price_Per_Day, available, rating) VALUES ('BMW K100', 'BMW', 'B1B11', 2022, 0, 'Descubra o futuro da AMG Driving Performance. E temos excelentes novidades, porque criamos um veículo totalmente elétrico que também é um autêntico AMG. Como sempre, praticidade no dia a dia e fascinação estão incluídas. Venha para a linha de largada.', 230.0, 900.0, true, 4.7);
INSERT INTO tb_motorcycle (id, has_Fairing) VALUES (4, true);

INSERT INTO tb_vehicle (name, brand, plate, manufacture_Year, status, description, price_Per_Hour, price_Per_Day, available, rating) VALUES ('Honda CG 160', 'Honda', 'A1A11', 2022, 1, 'Descubra o futuro da AMG Driving Performance. E temos excelentes novidades, porque criamos um veículo totalmente elétrico que também é um autêntico AMG. Como sempre, praticidade no dia a dia e fascinação estão incluídas. Venha para a linha de largada.', 50.0, 150.0, true, 3.4);
INSERT INTO tb_motorcycle (id, has_Fairing) VALUES (5, true);

INSERT INTO tb_vehicle (name, brand, plate, manufacture_Year, status, description, price_Per_Hour, price_Per_Day, available, rating) VALUES ('Ducati 750/900SS', 'Ducati', 'C1C11', 1991, 2, 'Descubra o futuro da AMG Driving Performance. E temos excelentes novidades, porque criamos um veículo totalmente elétrico que também é um autêntico AMG. Como sempre, praticidade no dia a dia e fascinação estão incluídas. Venha para a linha de largada.', 250.0, 1100.0, true, 5.0);
